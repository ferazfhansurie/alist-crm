...
export const api = {
  ...
  leadOverview: () => request('lead_overview'),
  leadDetail: (name) => request('lead_detail', { name }),
  createLead: (values) => request('create_lead', { values }, 'POST'),
  updateLead: (args) => request('update_lead', args, 'POST'),
  updateLeadDetails: (args) => request('update_lead_details', args, 'POST'),
  addLeadComment: (args) => request('add_lead_comment', args, 'POST'),
